...
import { Plus, Search, Folder, Crown, Users } from 'lucide-react';
        ...
        <div className="flex items-center gap-4">
          ...
          {user?.role === 'team_lead' && (
            <Button 
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-2 px-4 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg shadow-md border-2 border-transparent hover:border-white/30"
            >
